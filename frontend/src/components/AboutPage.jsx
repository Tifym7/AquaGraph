...
export default function AboutPage({ onGoToHome,  onGoToMap, onGoToNewsletter, onGoToCampaigns }) {
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: '#fff' }}>
      ...
      <AppBar position="sticky" elevation={0}>
        <Toolbar sx={{ gap: 1.5, minHeight: '95px !important' }}>
          ...
          <Box sx={{ flexGrow: 1 }} />
          <Button startIcon={<HomeIcon />} size="small" onClick={onGoToHome} sx={NAV_BTN}>Home</Button>
